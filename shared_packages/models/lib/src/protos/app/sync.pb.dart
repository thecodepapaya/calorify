...
import '../calorify/common.pb.dart' as $2;
import '../user/user.pb.dart' as $1;
import 'meal.pb.dart' as $0;
...
class SyncOp extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<SyncOpType>(2, _omitFieldNames ? '' : 'opType',
        enumValues: SyncOpType.values)
    ..aOS(3, _omitFieldNames ? '' : 'createdAt')
    ..aOM<$0.LoggedMeal>(4, _omitFieldNames ? '' : 'meal',
        subBuilder: $0.LoggedMeal.create)
    ..aOM<DeleteMeal>(5, _omitFieldNames ? '' : 'deleteMeal',
        subBuilder: DeleteMeal.create)
    ..aOM<$1.UserProfile>(6, _omitFieldNames ? '' : 'profile',
        subBuilder: $1.UserProfile.create)
    ..aOM<$2.FcmToken>(7, _omitFieldNames ? '' : 'fcmToken',
        subBuilder: $2.FcmToken.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SyncOp clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(4)
  $0.LoggedMeal get meal => $_getN(3);
  @$pb.TagNumber(4)
  set meal($0.LoggedMeal value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasMeal() => $_has(3);
  @$pb.TagNumber(4)
  void clearMeal() => $_clearField(4);
  @$pb.TagNumber(4)
  $0.LoggedMeal ensureMeal() => $_ensure(3);
  ...
  @$pb.TagNumber(6)
  $1.UserProfile get profile => $_getN(5);
  @$pb.TagNumber(6)
  set profile($1.UserProfile value) => $_setField(6, value);
  @$pb.TagNumber(6)
  $core.bool hasProfile() => $_has(5);
  @$pb.TagNumber(6)
  void clearProfile() => $_clearField(6);
  @$pb.TagNumber(6)
  $1.UserProfile ensureProfile() => $_ensure(5);

  @$pb.TagNumber(7)
  $2.FcmToken get fcmToken => $_getN(6);
  @$pb.TagNumber(7)
  set fcmToken($2.FcmToken value) => $_setField(7, value);
  @$pb.TagNumber(7)
  $core.bool hasFcmToken() => $_has(6);
  @$pb.TagNumber(7)
  void clearFcmToken() => $_clearField(7);
  @$pb.TagNumber(7)
  $2.FcmToken ensureFcmToken() => $_ensure(6);
}
...
class SyncBatch extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'app'),
      createEmptyInstance: create)
    ..pPM<SyncOp>(1, _omitFieldNames ? '' : 'ops', subBuilder: SyncOp.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SyncBatch clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class SyncAck extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'app'),
      createEmptyInstance: create)
    ..pPM<SyncResult>(1, _omitFieldNames ? '' : 'results',

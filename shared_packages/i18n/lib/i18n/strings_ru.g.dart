...
class _TranslationsMealFeedbackRu implements TranslationsMealFeedbackEn {
	...
	// Translations
	@override String get title => 'Что выглядит неправильно?';
	@override String get subtitle => 'Помогите нам улучшить анализ, выбрав одну или несколько проблем.';
	@override String get tellUsMore => 'Расскажите подробнее';
	@override String get describeIncorrect => 'Опишите, что было не так';
	@override String get submit => 'Отправить';
	@override String get issueFoodIdentification => 'Распознавание еды';
	@override String get issuePortionSize => 'Размер порции';
	@override String get issueCalorieDistribution => 'Распределение калорий';
	@override String get issueMacrosWrong => 'Макроэлементы неверны';
	@override String get issueMissingItems => 'Отсутствующие элементы';
	@override String get issueExtraItems => 'Лишние элементы';
...
extension on TranslationsRu {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'meal.feedback.title' => 'Что выглядит неправильно?',
			'meal.feedback.subtitle' => 'Помогите нам улучшить анализ, выбрав одну или несколько проблем.',
			'meal.feedback.tellUsMore' => 'Расскажите подробнее',
			'meal.feedback.describeIncorrect' => 'Опишите, что было не так',
			'meal.feedback.submit' => 'Отправить',
			'meal.feedback.issueFoodIdentification' => 'Распознавание еды',
			'meal.feedback.issuePortionSize' => 'Размер порции',
			'meal.feedback.issueCalorieDistribution' => 'Распределение калорий',
			'meal.feedback.issueMacrosWrong' => 'Макроэлементы неверны',
			'meal.feedback.issueMissingItems' => 'Отсутствующие элементы',
			'meal.feedback.issueExtraItems' => 'Лишние элементы',

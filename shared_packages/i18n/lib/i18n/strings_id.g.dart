...
class _Translations$meal$questionFlow$id extends Translations$meal$questionFlow$en {
	...
	@override String get countQuestion => 'Pilih jumlah';
	@override String get itemSizeQuestion => 'Pilih ukuran item';
	@override String get portionSizeQuestion => 'Pilih ukuran porsi';
	...
	@override String get invalidNumber => 'Masukkan nilai dalam rentang yang diperbolehkan';
}
...
class _Translations$meal$analysis$id extends Translations$meal$analysis$en {
	...
	@override String calorieRange({required Object min, required Object max}) => 'Rentang perkiraan: ${min}–${max} kkal';
...
extension on TranslationsId {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'meal.questionFlow.countQuestion' => 'Pilih jumlah',
			'meal.questionFlow.itemSizeQuestion' => 'Pilih ukuran item',
			'meal.questionFlow.portionSizeQuestion' => 'Pilih ukuran porsi',
			...
			'meal.questionFlow.invalidNumber' => 'Masukkan nilai dalam rentang yang diperbolehkan',
			...
			'meal.analysis.calorieRange' => ({required Object min, required Object max}) => 'Rentang perkiraan: ${min}–${max} kkal',

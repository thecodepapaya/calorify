...
class _TranslationsErrorsFr implements TranslationsErrorsEn {
	...
	// Translations
	@override String get rateLimitExceeded => 'Vous avez effectué trop de requêtes. Veuillez patienter un moment avant de réessayer.';
...
class _TranslationsFavoritesFr implements TranslationsFavoritesEn {
	...
	@override String get searchEmptySubtitle => 'Essayez un autre nom de plat, une autre quantité ou un autre type de repas.';
...
class _TranslationsFeedbackRatingFr implements TranslationsFeedbackRatingEn {
	...
	@override String get rateStepHeading => 'Évaluez sur le Play Store';
	@override String get emailStepHeading => 'Envoyez-nous vos commentaires par e-mail';
...
class _TranslationsHomeAiSummaryFr implements TranslationsHomeAiSummaryEn {
	...
	// Translations
	@override String get title => 'Votre résumé par l\'IA';
	@override String get logMore => 'Enregistrez davantage de repas dans les prochains jours pour obtenir des analyses personnalisées de l\'IA.';
...
class _TranslationsHomeIntakeHistoryFr implements TranslationsHomeIntakeHistoryEn {
	...
	@override String peakHour({required Object hour}) => 'Pic : ${hour}h00';
...
class _TranslationsSettingsExportMealHistoryFr implements TranslationsSettingsExportMealHistoryEn {
	...
	@override String get subtitle => 'Partagez un fichier CSV de vos repas enregistrés';
	@override String get shareText => 'Export de votre historique de repas Calorify';
...
extension on TranslationsFr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'errors.rateLimitExceeded' => 'Vous avez effectué trop de requêtes. Veuillez patienter un moment avant de réessayer.',
			...
			'home.aiSummary.title' => 'Votre résumé par l\'IA',
			'home.aiSummary.logMore' => 'Enregistrez davantage de repas dans les prochains jours pour obtenir des analyses personnalisées de l\'IA.',
			...
			'home.intakeHistory.peakHour' => ({required Object hour}) => 'Pic : ${hour}h00',
			...
			'favorites.searchEmptySubtitle' => 'Essayez un autre nom de plat, une autre quantité ou un autre type de repas.',
			...
			'settings.exportMealHistory.subtitle' => 'Partagez un fichier CSV de vos repas enregistrés',
			'settings.exportMealHistory.shareText' => 'Export de votre historique de repas Calorify',
			...
			'feedbackRating.rateStepHeading' => 'Évaluez sur le Play Store',
			'feedbackRating.emailStepHeading' => 'Envoyez-nous vos commentaires par e-mail',

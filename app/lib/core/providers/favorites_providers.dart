...
typedef FavoriteFilterOptions = ({String query, FavoriteSortOption sortOption});
...
final filteredFavoriteMealsProvider = Provider.autoDispose
    .family<List<FavoriteMeal>, FavoriteFilterOptions>((ref, options) {
...
class FavoriteMealsNotifier extends StreamNotifier<List<FavoriteMeal>> {
  ...
  Future<void> removeFavoriteMeal(FavoriteMeal favorite) {
    return ref
        .read(databaseInterfaceProvider)
        .removeFavoriteMeal(favorite.clientId);
  }

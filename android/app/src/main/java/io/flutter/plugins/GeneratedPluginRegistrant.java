...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new sh.measure.flutter.MeasurePlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin measure_flutter, sh.measure.flutter.MeasurePlugin", e);
    }
    try {

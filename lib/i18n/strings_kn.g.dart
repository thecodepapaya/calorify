...
class _TranslationsOnboardingReinforcementTrackingSuccessKn implements TranslationsOnboardingReinforcementTrackingSuccessEn {
	...
	@override String get getStartedTitle => 'ಆರಂಭಿಸಲು ಸಿದ್ಧವೇ?';
	@override String get tipPhoto => 'ತ್ವರಿತ ವಿಶ್ಲೇಷಣೆಗೆ ನೀವು ಸೇವಿಸುವ ಆಹಾರಗಳ ಫೋಟೋವನ್ನು ತೆಗೆದುಕೊಳ್ಳಿ';
	@override String get tipConsistency => 'ಸಂಪೂರ್ಣ ಏಕಕಾಲದಲ್ಲಿ ಲಾಗ್ ಮಾಡಿ, ಅರ್ಥಪೂರ್ಣ ಅಭಿವೃದ್ಧಿ ಕಾಣಲು';
	@override String get tipProgress => 'ಪ್ರೇರಣೆಯಲ್ಲಿರಲು ದಿನನಿತ್ಯ ನಿಮ್ಮ ಪ್ರಗತಿಯನ್ನು ಟ್ರಾಕ್ ಮಾಡಿ';
...
extension on TranslationsKn {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'onboarding.reinforcement.trackingSuccess.getStartedTitle' => 'ಆರಂಭಿಸಲು ಸಿದ್ಧವೇ?',
			'onboarding.reinforcement.trackingSuccess.tipPhoto' => 'ತ್ವರಿತ ವಿಶ್ಲೇಷಣೆಗೆ ನೀವು ಸೇವಿಸುವ ಆಹಾರಗಳ ಫೋಟೋವನ್ನು ತೆಗೆದುಕೊಳ್ಳಿ',
			'onboarding.reinforcement.trackingSuccess.tipConsistency' => 'ಸಂಪೂರ್ಣ ಏಕಕಾಲದಲ್ಲಿ ಲಾಗ್ ಮಾಡಿ, ಅರ್ಥಪೂರ್ಣ ಅಭಿವೃದ್ಧಿ ಕಾಣಲು',
			'onboarding.reinforcement.trackingSuccess.tipProgress' => 'ಪ್ರೇರಣೆಯಲ್ಲಿರಲು ದಿನನಿತ್ಯ ನಿಮ್ಮ ಪ್ರಗತಿಯನ್ನು ಟ್ರಾಕ್ ಮಾಡಿ',

...
await mock.module('../../../src/services/meal-analysis/historyStore.js', {
  namedExports: {
...
await mock.module('../../../src/middleware/auth.js', {
  namedExports: {
...
await mock.module('../../../src/services/nutrition/localResolver.js', {
  namedExports: {
    resolveLocalNutritionLookups: mockResolveLocalNutritionLookups,
  },
});

await mock.module('../../../src/services/nutrition/localPackDownload.js', {
...
const { foodRoutesV2 } = await import('../../../src/routes/v2/food.js');

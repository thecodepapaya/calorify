...
await mock.module('../../../src/services/infrastructure/database.js', { namedExports: { query: mockQuery } });

const { inspectUser } = await import('../../../src/services/meal-analysis/observability.js');

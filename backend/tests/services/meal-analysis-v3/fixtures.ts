    ...
    components: [
      {
        ...
        portionConstraint: {
          ...
          finishedGrams: modelConstraint(150, 150, 150, 'A 150 g finished serving is assumed.'),
          naturalMeasure: null,
      ...
      },
      {
        ...
        evidence: [modelEvidence('Oats are included to exercise ingredient-basis scaling.')],
        portionConstraint: {
          kind: 'AMOUNT',
          measurementBasis: 'INGREDIENT',
          finishedGrams: null,
          naturalMeasure: {
            unitCode: 'GRAM',
            quantity: modelConstraint(100, 100, 100, 'The dry-oat input is 100 g.'),
          },
          ingredientAnchorLeafId: 'oats',
        },
        preparationConstraints: [],

...
3. For each ingredient provide:
   ...
   - canonical_hint: simple food database lookup term for the atomic ingredient only (use common USDA-style naming, e.g. "wheat flour whole", "paneer", "onion", "tomato", "oil vegetable")
...
8. NEVER use synthetic slugs, paths, underscores, categories, or role labels as canonical_hint. Bad: "rotis/raw_ingredient", "oil_or_ghee_for_roti", "vegetable_curry", "salt_and_spices".
9. For named Indian dishes, do not split a bound dish phrase into a main food plus a generic duplicate dish. "paneer sabzi" is one dish context; do NOT emit both "paneer" and a separate generic "sabzi/vegetable curry" row. Instead emit likely ingredients under that dish context, such as "paneer sabzi (paneer)", "paneer sabzi (onion)", "paneer sabzi (tomato)", "paneer sabzi (oil/ghee)", and "paneer sabzi (spices)".

Portion references:
- 1 chapati/roti ≈ 30g whole wheat flour + 0-3g oil/ghee/butter + a pinch of salt

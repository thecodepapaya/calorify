...
await mock.module('./metrics.js', { namedExports: { instrumentAiCall: async (_provider: string, fn: () => Promise<unknown>) => fn() } });
...
const { AiSummaryRequestError, generateAiSummary } = await import('./aiSummaryService.js');

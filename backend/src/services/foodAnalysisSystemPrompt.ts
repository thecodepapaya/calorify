...
Example (for a text input like "bowl of oatmeal with banana"):
...
One-shot example:
Input (image or description): "plate with white rice, vegetable curry, and a small bowl of raita"
Expected JSON:
{"result":{"meal_identified":true,"calorie_confidence":"MEDIUM","tip":"Rice are a good source of carbohydrates. Be sure to include more protein in your meal.","meal":{"name":"Rice with vegetable curry and raita","quantity":"1 plate","type":"LUNCH","macros":{"calories":650,"carbs":95,"protein":12,"fat":18,"fiber":8},"health":{"health_score":"NEUTRAL","health_score_reason":"Mixed vegetables and rice; portion-dependent."}},"variations":[{"question":"Which portion size best matches this plate?","options":[{"option":"Small portion","macro_diff":{"calories":-160,"carbs":-24,"protein":-3,"fat":-5,"fiber":-2}},{"option":"Medium (as detected)","macro_diff":{"calories":0,"carbs":0,"protein":0,"fat":0,"fiber":0}},{"option":"Large portion","macro_diff":{"calories":160,"carbs":24,"protein":3,"fat":5,"fiber":2}}]}]}

Guidance: follow the one-shot example's structure when generating variations — Do not invent unrelated variation topics.`;
}

...
13. canonical_hint MUST be a simple, single English food-database lookup term — one ingredient, always in English regardless of input language. Use short base ingredient names without preparation qualifiers ("egg" not "whole egg" or "fried egg"; "lamb" not "lamb meat"; "thyme" not "dried thyme"; "onion" not "green onion" or "spring onion"; "anchovies" not "anchovy fish paste"). NEVER use slugs, underscores, role labels (e.g. "rotis/raw_ingredient"), or compound phrases with "or", "and", commas, or parentheses ("curry powder or garam masala", "lamb or beef kebab", "hogao (Colombian sauce)" are all wrong). When a dish admits multiple proteins, pick the single most traditional one for that named dish. One bare term per row.

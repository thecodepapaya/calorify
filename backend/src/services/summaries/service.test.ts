...
await mock.module('../infrastructure/metrics.js', { namedExports: { instrumentAiCall: async (_provider: string, fn: () => Promise<unknown>) => fn() } });
await mock.module('../infrastructure/openaiClient.js', {
  defaultExport: class {
...
const { AiSummaryRequestError, generateAiSummary } = await import('./service.js');
